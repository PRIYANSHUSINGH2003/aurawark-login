    ...
    <div className="flex-1 flex flex-col items-center mt-10 md:mt-20">
      <div className="w-[95%] md:w-[40%] mx-auto">
        ...
        <form className="space-y-10 mt-8" onSubmit={handleSubmit(onSubmit)}>
          ...
          <Button
            type="submit"
            className="mt-12 w-full h-12 text-sm font-bold text-white bg-[color:var(--aiortho-primary)] hover:bg-[color:var(--aiortho-primary)] py-5 md:mb-16 rounded-full cursor-pointer"
          >
            회원가입
          </Button>
        </form>
